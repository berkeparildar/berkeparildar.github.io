...
export class ProjectsComponent implements OnInit {
  projects: Project[] = [
    ...
    },
    {
      ...
      imageUrl: 'assets/pictures/factoryrun/factoryrun.png',
      description: "Factory Run is an exhilarating endless runner game that takes heavy inspiration from popular games like Subway Surfers." +
        " In Factory Run, players control a character who continuously runs forward through an industrial setting." +
        " The objective is to navigate between three columns or roads, avoiding obstacles and collecting coins to achieve the highest score possible." +
        " The game features dynamically changing platforms, with some segments randomly elevated, and randomly spawned obstacles," +
        " challenging players platform skills. Gaps can also appear on elevated platforms, requiring precise jumps to avoid falling.",
      titleOne: "Features",
      partOne: "Endless runner gameplay with non-stop action and dynamic platform changes." +
        "_Three lanes to navigate, providing strategic choices to avoid obstacles." +
        "_Elevation mechanic with randomly generated high platforms and gaps, adding variety and challenge." +
        "_Obstacles such as boxes to jump over and small tunnels to slide under." +
        "_Coin collection system to boost your score and unlock new characters." +
        "_Intuitive swipe controls, making the game accessible and easy to play." +
        "_Beautiful appearance with Unity Post Processing and an industrial theme, immersing players in the factory setting." +
        "_Aim for the highest score, compete with friends, and unlock all characters to master Factory Run." +
      ...
      titleTwo: "How to Play",
      partTwo: "The character runs forward automatically; your job is to navigate and survive." +
        "_Swipe left or right to switch between three columns." +
        "_Swipe up to jump over obstacles like boxes on the ground level." +
        "_Swipe down to slide under obstacles like small tunnels on the ground level." +
        "_Keep an eye on the platforms ahead; some parts can be elevated, requiring a jump to continue." +
        "_Be cautious of gaps that might appear on the elevated platforms; time your jumps carefully." +
        "_Collect coins scattered throughout the course to increase your score." +
        "_Use collected coins to unlock different characters.",
      videoId: "https://www.youtube.com/embed/v6rg9e2535c",
      imageOnePath: "assets/pictures/factoryrun/gameplay.gif",
      imageTwoPath: "assets/pictures/factoryrun/shop.gif",
      imageThreePath: "assets/pictures/factoryrun/death.gif",
      hasVideo: true
    },
    {
      genre: 'Driving Game',
    ...
    },
    {
      genre: 'Runner Game',
      title: 'Gun Run',
      repoLink: 'https://github.com/berkeparildar/Gun-Run',
    ...
    },
    {
      genre: 'RPG Game',
      title: "Druid's Tale",
      repoLink: 'https://github.com/berkeparildar/Druids-Tale',
    ...
    },
    {
      genre: 'Golf Game',
      title: 'Putt Time',
      repoLink: 'https://github.com/berkeparildar/Putt-Time',
    ...
    },
    {
      ...
      imageUrl: 'assets/pictures/helpchain/helpchain.jpg',
      description: "This is the capstone project I worked on with my friends. Project's main goal and motivation are to provide a new blockchain based solution to disaster management." +
        " Disaster management consists of a series of disaster-related information processes in which the information is processed, stored, and disseminated to make effective decisions and construct a plan." +
        " Most of the current disaster management systems are infrastructure-dependent and work in a centralized manner, which can pose a threat in certain devastating outcomes." +
        " The involvement of both the government and the public is important in gathering and disseminating information, and their effectiveness would be severely diminished if these centralized and infrastructure dependent systems were to fail during the moments of disaster.",
      titleOne: "Components",
      partOne: "During the registration process, the user has to register with the system through a server because it is not feasible to" +
        " create and deploy a smart contract from a mobile phone. Therefore, to sign up for the system, users must" +
        " communicate with the server instead of the blockchain. The server gets the data that the user sends as parameters, which" +
        " are \"Name\", \"Surname\", \"Address\", \"TCKN\" (Turkish State ID number) and using these parameters, it creates and" +
        "deploys a smart contract. After creating and deploying the user’s contract to the system, the server provides the user his" +
        "or her contract hash and writes that contract hash value to the Firebase. Users are required to access the blockchain with" +
        "their own contract hash. This contract hash value is kept in a database to access the contracts from the desktop applications used by the relief organizations." +
        "Once registered, all the modifications to the existing records, such as address or status, will be reflected in the user's" +
        " smart contract on the blockchain, by the server." +
        "_The desktop application, which is the organization interface, provides the users at the organization with the" +
        " ability to traverse the blockchain according to the list of the users’ contracts obtained from the Firebase and read their" +
        " latest data to list the people in the blockchain with the status and address values." +
        "_In the mobile application, users can create and log in to their own accounts. They will be logging in with their citizenship numbers and the password that they assigned for their accounts." +
        "The registered users can change their status to \"In distress\", \"Need Help\", \"Safe\" depending on the circumstances they are in during or after a disaster. They can" +
        " also change their home address, preferably before the disastrous conditions take place, in case they move to a new location.",
      titleTwo: "System Overview",
      partTwo: 'We used a Metamask coin wallet to test the smart contracts that we have written using Solidity language. As the testing network, we chose the Sepolia Ethereum Testing' +
        ' Network because of its similarities to the popular commercial blockchain networks.' +
        '_Infura is the tool that we use to get connection addresses' +
        ' on the Sepolia Ethereum test network. It provided us with the' +
        ' API’s for that task.' +
        "_Flutter is a framework that is built on Dart programming" +
        "language. It is a cross platform development environment" +
        "which means that we can publish the mobile application with" +
        "single codebase in both Android and iOS. It has access to" +
        "numerous tools such as Firebase connectivity and Web3" +
        "accesses." +
        "_We utilized .NET/.NET Core’s Windows Presentation" +
        "Foundation (WPF) app for the desktop application (the" +
        "application which the disaster organizations will use) as part" +
        "of the system. The reason we have chosen the .NET/.NET" +
        "Core is that it has a wide range of integration possibilities" +
        "with the technologies that are in the Microsoft ecosystem." +
        "_Etherscan is a popular blockchain explorer and analytics" +
        "platform especially designed for the Ethereum network. It" +
        "provides us a means to track various Ethereum blockchain" +
        "data that users send, such as transactions, smart contract" +
        "creation, and event updates. We used this tool mainly when" +
        "we did not have our “blockchain reading code” to validate" +
        "and inspect the transactions and events that we send to the" +
        "smart contracts.",
      videoId: "https://www.youtube.com/embed/7xJhA1cR8V0",
    ...
    },
    {
      genre: 'Shooter Game',
      title: 'ZomCube',
      repoLink: 'https://github.com/berkeparildar/ZomCube',
    ...
    },
    {
      ...
      description: "Cookbook is a user-friendly mobile application developed using the Flutter framework that serves as your digital recipe organizer." +
        " With Cookbook, you can effortlessly store, manage, and follow your favorite cooking recipes." +
        " Cookbook makes cooking more enjoyable and organized, ensuring that you have all your favorite recipes at your fingertips.",
      titleOne: "Features",
      partOne: "Cookbook integrates Google authentication for a seamless and secure sign-in process." +
        " Users can sign in using their Google accounts, ensuring easy access to their recipe collection." +
        "_Adding your recipes is a breeze with Cookbook. Simply provide the recipe's name, description, and any notes you'd like to include as helpful reminders." +
        " Select from a variety of tags to categorize your recipe for quick searching." +
        "_When viewing a recipe, Cookbook offers an interactive slide view for the cooking and preparation methods." +
        " Users can swipe through the steps, ensuring a smooth and guided cooking experience." +
        "_For instructions that require precise timing, Cookbook provides a built-in timer. Users can manage their cooking process with ease, thanks to this convenient feature." +
        "_Looking for a specific recipe? Cookbook lets users search for recipes by name directly from the recipe list, saving time and effort." +
        "_Users can mark recipes as favorites for quick access to their preferred dishes." +
        " Additionally, they can explore recipes based on specific tags, making it simple to discover recipes within desired categories.",
      titleTwo: "How to Use",
      partTwo: " Launch the Cookbook app. Sign in using your Google account to start managing your recipes." +
        "_To add a recipe, click on the \"Add Recipe\" button. Enter the recipe's name, description, and any relevant notes. Choose tags that best represent the recipe." +
        " Include the required ingredients and provide a step-by-step method. Specify cooking and preparation time. Hit \"Save\" to add the recipe to your collection." +
        "_On the main menu, you'll find your list of saved recipes. Tap on a recipe to view its details." +
        "_ Inside a recipe, tap the play button to access the interactive cooking guide. Swipe through the steps to follow the method." +
        " Utilize the built-in timer for time-sensitive instructions." +
        "_Use the search bar to find recipes by name. Explore your favorite recipes under the \"Favorites\" section. Click on tags to view recipes within specific categories.",
      videoId: "https://www.youtube.com/embed/7xJhA1cR8V0",
    ...
    },
    {
      genre: 'Arcade Game',
      title: 'DINO',
      repoLink: 'https://github.com/berkeparildar/DINO',
    ...
    },
    {
      ...
      repoLink: 'https://github.com/berkeparildar/Dungeon-Escape',
    ...
    },
    {
      genre: 'Arcade Game',
      title: 'Space Shooter',
      repoLink: 'https://github.com/berkeparildar/Space-Shooter',
